                ...
                <section className="container mt-40">
                    ...
                    <div className="grid grid-cols-1 gap-10 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-900 px-4 py-8 sm:p-8 md:p-12 lg:p-16">
                        <div className="text-white">
                            ...
                            <p className="mb-5">Diese Datenschutzerklärung soll die Nutzer dieser Website über die Art, den Umfang und den Zweck der Erhebung und Verwendung personenbezogener Daten durch den Websitebetreiber [Ihre Kontaktdaten einfügen] informieren.</p>
                            ...
                            <p className="mb-5">Wir verarbeiten personenbezogene Daten wie Vorname, Nachname, IP-Adresse, E-Mail-Adresse, Wohnort, Postleitzahl und Inhaltsangaben aus dem Kontaktformular.</p>
